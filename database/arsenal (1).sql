...
CREATE TABLE `product` (
  ...
  `description_product` text COLLATE utf8mb4_vietnamese_ci NOT NULL,
  `sale` int NOT NULL,
  `hot` int NOT NULL,
  `id_category` int NOT NULL,
  `quanlity_product` int NOT NULL
...
INSERT INTO `product` (`id_product`, `img_product`, `name_product`, `price_product`, `description_product`, `sale`, `hot`, `id_category`, `quanlity_product`) VALUES
(1, 'product-1.webp', 'Áo Arsenal adidas 24/25 Originals', 2888800, 'Đồ thể thao, nhưng hãy làm cho nó tinh tế. Mang phong cách adidas cổ điển, Áo sơ mi Arsenal adidas 24/25 Originals kết hợp thiết kế cổ điển với tính thẩm mỹ hiện đại. Với kiểu dáng ôm sát tăng cường chuyển động, chi tiết 3 sọc biểu tượng ở vai và khẩu pháo nhiệt ở ngực, nó sẽ giúp bạn ấm áp theo phong cách trong nhiều mùa tới.\r\n\r\nChiếc áo adidas này được làm từ vật liệu tái chế như một phần trong tham vọng chung tay chấm dứt rác thải nhựa của chúng tôi.\r\n\r\nPháo được gia nhiệt ở ngực\r\nKhẩu hiệu AFC thêu ở cổ áo\r\nCổ tròn có gân\r\nVừa vặn\r\nMàu sắc: Xanh lam\r\n\r\nMã sản phẩm: MIS6505\r\n\r\n\r\nChất liệu: 100% polyester tái chế', 1, 1, 1, 1000),
(2, 'product-2.webp', 'Áo hoodie Arsenal adidas 24/25 Originals', 2888800, 'Kết hợp vẻ ngoài cổ điển với sự thoải mái cao cấp và chất liệu thân thiện với môi trường, Áo hoodie Arsenal 24/25 Originals là sản phẩm gần nhất mà bạn có thể có được với sự hoàn hảo trong tủ đồ. Được chế tác từ hỗn hợp cotton và polyester ấm áp, áo có kiểu dáng hộp thoải mái, bo gấu tay và gấu áo có gân và họa tiết đại bác thêu ở giữa ngực để tạo nên phong cách mới mẻ cho trang phục thể thao cổ điển, theo phong cách của Arsenal.\r\n\r\nChiếc áo hoodie adidas này được làm một phần từ vật liệu tái chế như một phần trong tham vọng chung tay chấm dứt rác thải nhựa của chúng tôi.\r\n\r\nPháo thêu\r\nVừa vặn rộng rãi\r\nMũ trùm đầu có thể điều chỉnh bằng dây rút\r\nCổ tay và gấu áo có gân\r\nTúi trước\r\nMàu sắc: Xanh lam\r\n\r\nMã sản phẩm: MIS6501\r\n\r\n\r\nChất liệu: 78% cotton, 22% polyester tái chế', 0, 0, 1, 1000),
