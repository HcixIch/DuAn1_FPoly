                            ...
                            <div
                                ...
                                <div class="header-top-links">
                                    <ul>
                                        ...
                                        <li><a href="#"><i class="fa fa-envelope-open-o"></i>ichndps41009@gmail.com</a>
                                        </li>
                                    </ul>
                                </div>
                                <!--Links end-->
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-3 col-md-3 col-6 order-lg-1 order-md-1 order-1">
                                <div class="logo">
                                    <a href="index.php"><img src="assets/images/arsenallogo2.svg"
                                            alt="logo TG shop"></a>
                                </div>
                            </div>
                            <!--Logo end-->
                            ...
                            <div
                                ...
                                <nav class="main-menu">
                                    <ul>
                                        ...
                                        <li><a href="?ctrl=product&&view=shop">Cửa hàng</a></li>
                            ...
                            <div
                                ...
                                <div class="header-search">
                                    ...
                                    <div class="header-search-form">
                                        <form action="#">
                                            <input type="text" placeholder="Nhập từ khóa và nhấn enter">
