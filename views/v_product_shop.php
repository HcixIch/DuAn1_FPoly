                ...
                <div class="col-lg-3 order-lg-1 order-2">
                    ...
                    <div class="common-sidebar-widget">
                        ...
                        <ul class="sidebar-list">
                            ...
                            <li><a href="#"><i class="fa fa-angle-right"></i>Orange <span class="count">(4)</span></a>
                            </li>
                            <li><a href="#"><i class="fa fa-angle-right"></i>Blue <span class="count">(4)</span></a>
                            </li>
                            <li><a href="#"><i class="fa fa-angle-right"></i>Black <span class="count">(4)</span></a>
                            </li>
                            <li><a href="#"><i class="fa fa-angle-right"></i>Green <span class="count">(4)</span></a>
                            </li>
                        </ul>
                    </div>
                    <!-- Single Sidebar End  -->
                    ...
                    <div class="common-sidebar-widget">
                        ...
                        <ul class="sidebar-list">
                            <li><a href="#"><i class="fa fa-angle-right"></i>Aliquam <span class="count">(5)</span></a>
                            </li>
                                                        ...
                                                        <div class="product-content-shop-list">
                                                            <div class="product-content">
                                                                <h3><a href="single-product.html">Aftershave
                                                                        Lotion</a></h3>
                                                                <h4 class="price"><span class="new">€90.00</span><span
