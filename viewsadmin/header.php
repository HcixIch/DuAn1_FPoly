...
<head>
    ...
    <!-- Bootstrap core CSS     -->
    <link href="./assets/public/stylesheets/bootstrap.min.css" rel="stylesheet" />

    <!-- Animation library for notifications   -->
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>

    <link href="./assets/public/stylesheets/animate.min.css" rel="stylesheet" />

    <!--  Light Bootstrap Table core CSS    -->
    <link href="./assets/public/stylesheets/light-bootstrap-dashboard.css" rel="stylesheet" />


    <!--  CSS for Demo Purpose, don't include it in your project     -->
    <link href="./assets/public/stylesheets/demo.css" rel="stylesheet" />
    <link href="./assets/public/stylesheets/style.css" rel="stylesheet" />
